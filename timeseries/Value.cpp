...
[[noreturn]] void report_bad_conversion()
{
  Fmi::Exception error(BCP,
                       "Conversion from " + Fmi::demangle_cpp_type_name(typeid(From).name()) +
...
template <>
double GetDoubleVisitor::operator()(const int& arg) const
{
  return arg;
}
template <>
double GetDoubleVisitor::operator()(const double& arg) const
{
  return arg;
}
template <>
double GetDoubleVisitor::operator()(const std::string& arg) const
{
  return Fmi::stod(arg);
}
...
template <>
int GetIntVisitor::operator()(const int& arg) const
{
  return arg;
}
template <>
int GetIntVisitor::operator()(const double& arg) const
{
  return arg;
}  // FIXME: check range
template <>
int GetIntVisitor::operator()(const std::string& arg) const
{
  return Fmi::stoi(arg);
}
}  // namespace
