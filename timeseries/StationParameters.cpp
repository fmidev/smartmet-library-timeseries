...
try : Fmi
  ::FunctionMap<Value, StationParameterArgs>()
  {
    add(DIRECTION_PARAM,
    ...
    add(STATION_ELEVATION_PARAM,
        [](const StationParameterArgs& args) -> Value { return args.station.elevation; });

    add({STATIONTYPE_PARAM, MODEL_PARAM},
        [](const StationParameterArgs& args) -> Value { return args.station.type; });
    ...
    add(PLACE_PARAM, [](const StationParameterArgs& args) -> Value { return args.station.tag; });
    ...
    add({LATITUDE_PARAM, STATIONLATITUDE_PARAM},
        [](const StationParameterArgs& args) -> Value { return args.station.latitude; });

    add({LONGITUDE_PARAM, STATIONLONGITUDE_PARAM},
        [](const StationParameterArgs& args) -> Value { return args.station.longitude; });
    ...
    add(NAME_PARAM,
        [](const StationParameterArgs& args) -> Value { return args.station.modified_by; });
